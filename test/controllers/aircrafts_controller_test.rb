...
class AircraftsControllerTest < ActionController::TestCase
  ...
  test "should create aircraft" do
    assert_difference('Aircraft.count') do
      post :create, aircraft: { designation: @aircraft.designation, name: @aircraft.name, numbers_built: @aircraft.numbers_built }
    end
  ...
  test "should update aircraft" do
    patch :update, id: @aircraft, aircraft: { designation: @aircraft.designation, name: @aircraft.name, numbers_built: @aircraft.numbers_built }
    assert_redirected_to aircraft_path(assigns(:aircraft))
  end
