...
class TanksControllerTest < ActionController::TestCase
  ...
  test "should create tank" do
    assert_difference('Tank.count') do
      post :create, tank: { description: @tank.description, designation: @tank.designation, name: @tank.name, numbers_built: @tank.numbers_built }
    end
  ...
  test "should update tank" do
    patch :update, id: @tank, tank: { description: @tank.description, designation: @tank.designation, name: @tank.name, numbers_built: @tank.numbers_built }
    assert_redirected_to tank_path(assigns(:tank))
  end
